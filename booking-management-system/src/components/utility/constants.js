...
export const userAPI = `https://bms-backend-spring-prelive.herokuapp.com/api/v1/users/`;
export const roomsCountAPI =
  "https://bms-backend-spring-prelive.herokuapp.com/api/v1/admins/roomscount/";
export const usersCountAPI =
  "https://bms-backend-spring-prelive.herokuapp.com/api/v1/admins/customercount/";
export const todaysRevenue =
  "https://bms-backend-spring-prelive.herokuapp.com/api/v1/admins/revenue/today/";
export const totalRevenue =
  "https://bms-backend-spring-prelive.herokuapp.com/api/v1/admins/revenue/";
export const propertiesAPI =
  "https://bms-backend-spring-prelive.herokuapp.com/api/v1/properties/";
export const clientId =
  "168682750427-9bd8ftc7gmmi1fm5fcb96m36iai8q484.apps.googleusercontent.com";
export const subscriptionAPI =   "https://bms-backend-spring-prelive.herokuapp.com/api/v1/subscriptions/";

export const userDeleteAPI = "https://bms-backend-spring-prelive.herokuapp.com/api/v1/users/delete/"
export const propertyDeleteAPI = "https://bms-backend-spring-prelive.herokuapp.com/api/v1/properties/delete/"
export const promotionsAPI = "https://bms-backend-spring-prelive.herokuapp.com/api/v1/promotions/"
export const checkoutAPI = "https://bms-backend-spring-prelive.herokuapp.com/api/v1/bookings/checkout/"
